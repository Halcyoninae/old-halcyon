...
static inline int vert__(const uint8_t src[], int stride, int q_ratio)
{
    ...
    {
/***************************************************************************
 * STRIDE HERE WORKS BETTER FOR RANGE OF [SRC[0]*-1, SRC[SRC[SRC.LEN]]*-1) *
 ***************************************************************************/
...
static inline int horz_ok_x1(const uint8_t src[], int stride, int q_ratio)
{
    int r=0;
    static uint64_t buffer[255];
/********************************************
 * 32-BIT DEVICES SHOULD MANUALLY ALLOC 256 *
 ********************************************/
...
/*******************************************************************************
 * THIS FUNC ROUTINE DOESNT WORK HALF OF THE TIME DUE TO UNSIGNED MAGIC!!! OMG *
 *******************************************************************************/
